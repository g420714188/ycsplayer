...
<!--            </div>-->
        ...
        <div class="flex justify-center items-center grow min-h-0 text-center">
            <div>
                ...
                <h1 class="mt-4 text-6xl font-bold tracking-wide sm:text-7xl">Online Player</h1>
                <h2 class="text-2xl text-blue-200/75 tracking-wide mt-4 sm:text-3xl sm:mt-8">線上影音點播</h2>
